  ...
  const steps = [
    {
      ...
      desc: 'Browse SHEIN, TEMU, iHerb, AliExpress, ASOS, or YesStyle on your phone or computer. Copy the links of the products you want.',
      icon: ShoppingBag,
    ...
    },
    {
      ...
      desc: 'Transfer the MVR total to our Bank of Maldives or Maldives Islamic Bank account. No dollar cards or foreign exchange fees needed.',
      icon: CreditCard,
    ...
    },
    {
      ...
      desc: 'We clear customs at Malé port and deliver straight to your door in Malé/Hulhumalé or handover to your island cargo boat.',
      icon: Truck,
    ...
    <div className="py-8 sm:py-14 space-y-12">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
        ...
        <p className="text-xs sm:text-sm text-slate-600 max-w-xl mx-auto">
          From link selection to doorstep delivery in the Maldives — we make international pre-ordering effortless and 100% accessible in MVR.
        </p>
      </div>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className={`w-11 h-11 rounded-2xl ${s.color} flex items-center justify-center shadow-xs`}>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-soft space-y-4">
          ...
          <div className="space-y-2 text-xs text-slate-700 pt-1">
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/80 flex justify-between items-center">
              <span><strong>Self-Collection:</strong> Malé Hub</span>
            ...
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/80 flex justify-between items-center">
              <span><strong>Hulhumalé:</strong> Doorstep delivery</span>
      ...
      {/* Clean CTA Footer */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-2">
        <Link
          href="/order"
          className="inline-flex items-center gap-2 bg-slate-950 hover:bg-slate-800 text-white font-bold text-sm px-8 py-4 rounded-full shadow-md transition"
        >
          <span>Start Your Order Online</span>
